...
class AddFavoriteTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.test_product = Product.objects.create(codebar='1',name='test_product')
    ...
    def test_adding_favorite(self):
        ...
        response = self.client.post(reverse('add_fav'), json.dumps(body), content_type='application/json')
